...
void StudentTests(){
	...
	Rope r8(IndexTestRope());
	Rope r9;

	std::cout << "\n\n\nTESTING SPLIT AT INDEX 21\n-last available character\n\n";
	r8.split(21,r9);
	std::cout << "LEFT:\n";
	r8.print(std::cout);
	std::cout << "\nRIGHT:\n";
	...
	Rope r10(IndexTestRope());
	Rope r11;

	std::cout << "\n\n\nTESTING SPLIT AT INDEX 22\n-out of bounds\n\n";
	r10.split(22,r11);
	std::cout << "LEFT:\n";
	r10.print(std::cout);
	std::cout << "\nRIGHT:\n";
